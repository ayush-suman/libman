...
userse:
	printf("Press 1 to delete the user %s\n", usern);
...
issoption:
	printf("Press 1 to select a book\n");
	printf("Press 2 to go to main page\n");
	char rs[50];
	scanf("%s", rs);
	int r = atoi(rs);
...
setopt:
	printf("Press 1 to delete your account\n");
...
venopt:
	...
	if (p == 1)
	{
		...
		int qua = 0;
	entquat:
		printf("Enter the quantity of book that you want to purchase\n");
		scanf("%s", quae);
		qua = atoi(quae);
		if (qua == 0)
		{
